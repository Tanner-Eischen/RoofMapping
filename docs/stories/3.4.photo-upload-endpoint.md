...
## Acceptance Criteria
- [x] API route created (`app/api/assist/upload/route.ts`)
...
- [x] Create photo records in database
- [ ] Submit enhanced analysis job to queue
- [x] Return 200/201 on success
- [x] Error handling for upload failures

## Tasks / Subtasks
- [x] Implement `POST /api/assist/upload` (AC: 1)
- [ ] Multipart parsing and validation (AC: 2-4)
- [ ] Upload to storage provider (AC: 5)
- [x] Create DB records and link to analysis (AC: 6)
- [ ] Submit enhanced job to queue (AC: 7)
- [x] Return 200/201; error handling (AC: 8-9)
