...
- [x] Server-side PDF route implemented (`/api/export/pdf`)
- [x] PDF includes: address, date, measurements (MVP)
- [ ] Satellite image included
- [ ] Professional formatting matching brand guidelines
- [ ] Generated filename: "RoofReport_[Address]_[Date].pdf"
- [x] Download triggered on button click
