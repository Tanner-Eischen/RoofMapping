...
## Acceptance Criteria
- [x] Address input page implemented (`app/address/page.tsx`)
- [ ] Google Maps Places Autocomplete integrated
- [ ] Input validation (must select from autocomplete)
- [x] Error states displayed for invalid addresses
- [x] "Analyze Roof" button enabled only when valid address selected
- [x] Navigation to processing screen on submission
- [x] Mobile-responsive layout baseline
- [x] Accessibility: ARIA label on input; keyboard submit
