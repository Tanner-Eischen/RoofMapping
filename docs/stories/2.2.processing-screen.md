...
## Acceptance Criteria
- [x] Processing page implemented (`app/processing/page.tsx`)
- [x] Spinning loader / progress indicator
- [x] Display submitted address or status copy
- [x] Status text: "Analyzing Roof" and "Processing satellite and LiDAR data..."
- [x] Automatic navigation from Screen 1
- [x] Poll for results every 2 seconds (starts after 2 seconds)
- [x] Poll starts 2 seconds after page load (not immediately)
- [x] Poll interval: exactly 2 seconds between requests
- [x] Stop polling on navigation away from page
- [x] Show 'Taking longer than expected' message after 30s
- [x] Navigate to results when status = "completed"
- [x] Navigate to mobile assist when status = "needs_assist"
- [x] Timeout after 30s: show retry button
- [x] Timeout after 60s: redirect to mobile assist

## Tasks / Subtasks
- [x] Implement `app/processing/page.tsx` with progress indicator and copy (AC: 1-3)
- [x] Add status copy and timing behaviors (AC: 4, 6-10)
- [x] Implement polling with 2s delay and interval (AC: 6-8)
- [x] Handle navigation on status changes (AC: 11-12)
- [x] Implement timeouts and retry flow (AC: 13-14)
