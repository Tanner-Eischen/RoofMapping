...
## Tasks / Subtasks
- [ ] Implement `/assist` page and guidance copy (AC: 1-2)
- [ ] Build `PhotoGuideCard` and `CameraModal` (AC: 3-4)
- [ ] Add photo preview and retake (AC: 5-6)
- [ ] Enable submit on 3 photos and upload flow (AC: 7-8)
- [ ] Navigate to results post-processing (AC: 9)
- [ ] Compress images before upload (AC: 10)
